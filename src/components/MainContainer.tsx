  ...
  return (
    <div className="flex h-screen flex-col bg-gray-50">
      <header className="flex items-center justify-between border-b border-gray-200 bg-white px-6 py-3 shadow-sm">
        <div>
          <h1 className="text-sm font-semibold text-gray-900">Flow Connector</h1>
          <p className="text-xs text-gray-500">Preview updates as you fine-tune the connection.</p>
        </div>
      ...
      <main className="relative flex flex-1 overflow-hidden">
        <PreviewFlow config={appState.config} onRequestSidebar={onRequestSidebar} />
      </main>

      <Sheet open={isSidebarOpen} onOpenChange={onSidebarOpenChange} modal={false}>
