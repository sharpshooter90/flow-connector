...
export class ArrowRenderer {
  createArrowHead(endPoint: Point, angle: number, config: ConnectionConfig): VectorNode | null {
  ...
  createStartArrowHead(startPoint: Point, angle: number, config: ConnectionConfig): VectorNode | null {
